...
class SingleChapterReviser:
    ...
    def __init__(self, api_key: str = None, instructions_file: str = "revision_instructions.md"):
...
Examples:
  ...
  python single_chapter_reviser.py glasshouse --chapter 8 --context-chapters 2,6,7 --cost-optimize --target-words 2500
    ...
    parser.add_argument(
        "--instructions-file",
        type=str,
        default="revision_instructions.md",
        help="Markdown file containing revision guidelines"
    )
    ...
    # Initialize reviser
    try:
        reviser = SingleChapterReviser(instructions_file=args.instructions_file)
